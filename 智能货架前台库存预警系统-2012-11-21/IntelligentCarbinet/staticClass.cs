...
namespace PublicConfig
{
    ...
    {
        public static int tagsBufferTime = 15000;//读取标签的缓冲时间
        ...
        public static string get_product_category_sync_list_url()
        {
            return string.Format("http://{0}:{1}/index.php/Standarder/ProductCategory/get_category_list", restIP, restPort);
        }
        public static MonitorMode mode = MonitorMode.讲解模式;
