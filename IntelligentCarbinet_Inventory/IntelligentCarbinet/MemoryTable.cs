...
namespace IntelligentCarbinet
{
    public class MemoryTable
    {
        ...
        public static DataTable unitTable = null;//货位的映射
        public static DataTable remindTable = null;//统计标签数量，专为缺货提醒服务
        ...
        static bool initializeTabes()
        {
            ...
            else
            {
                ...
                if (ds.Tables.IndexOf("remindTable") == -1)
                {
                    ...
                    ds.Tables.Add(remindTable);
                }
                else
                {
                    remindTable = ds.Tables["remindTable"];
                }
