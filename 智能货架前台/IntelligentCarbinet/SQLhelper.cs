...
namespace IntelligentCarbinet
{
    ...
    public sealed class SqlHelper
    {
        ...
        */
        ...
        public static DataSet ExecuteDatasetText(string connectionString, string commandText, params object[] parameterValues)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (parameterValues != null && parameterValues.Length > 0)
                {
                    ...
                    SqlParameter[] commandParameters = DeriveParameters(commandText, parameterValues);
        ...
        public static DataSet ExecuteDataset(SqlConnection connection, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, connection, (SqlTransaction)null, CommandType.Text, commandText, commandParameters, out mustCloseConnection);
        ...
        public static SqlParameter[] DeriveParameters(string commandText, object[] paramList)
        {
            if (paramList == null) return null;
            //SQLiteParameterCollection coll = new SQLiteParameterCollection();
            List<SqlParameter> coll = new List<SqlParameter>();
